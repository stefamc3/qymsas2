...
namespace QYMSAS
{
    class basededatos
    {
        ...
        public static String ConsultaStatusUsuario(String usuario, String contraseña)
        {
            ...
            try
            {
                MySqlCommand comando = new MySqlCommand(String.Format("select estado, usuario, contraseña from usuarios where (usuario='{0}' and contraseña= sha2('{1}',256) )", usuario, contraseña), basededatos.ObtenerConexion());
        ...
        public static Int32 ConsultaTipoUsuario(String usuario, String contraseña)
        {
            ...
            try
            {
                MySqlCommand comando = new MySqlCommand(String.Format("select tipo, usuario, contraseña from usuarios where (usuario='{0}' and contraseña= sha2('{1}',256))", usuario, contraseña), basededatos.ObtenerConexion());
        ...
        public static Int32 ObtenerIDusuario(String usuario, String contraseña)
        {
            ...
            try
            {
                MySqlCommand comando = new MySqlCommand(String.Format("select id_us, usuario, contraseña from usuarios where (usuario='{0}' and contraseña= sha2('{1}',256))", usuario, contraseña), basededatos.ObtenerConexion());
        ...
        public static int RegistrarUsuario(String nombre, String apellido, String usuario, String contraseña, String email, String tipo, String idTrabajador)
        {
            ...
            try
            {
                ...
                MySqlCommand comando = new MySqlCommand(String.Format("insert into usuarios(nombre,apellido,usuario,contraseña,email,tipo,estado,usuarios_id_trabajador) values ('{0}','{1}','{2}',sha2('{3}',256),'{4}','{5}','{6}','{7}')", nombre, apellido, usuario, contraseña,email,tipo,estado,idTrabajador), basededatos.ObtenerConexion());
        ...
        public static int Modificarcontraseña(String usuario, String contraseña)
        {
            ...
            try
            {
                MySqlCommand comando = new MySqlCommand(String.Format("update usuarios set contraseña = sha2('{0}',256) where usuario='{1}'", contraseña, usuario), ObtenerConexion());
                registro = comando.ExecuteNonQuery();
            }
            catch (Exception)
            {
        ...
        public static int ModificaContraseña(String contraseña, String id_us)
        {
            ...
            try
            {
                MySqlCommand comando = new MySqlCommand(String.Format("update usuarios set contraseña = sha1(md5('{0}')) where id_us ='{1}'", contraseña, id_us), ObtenerConexion());
                registro = comando.ExecuteNonQuery();
            }
            catch (Exception)
            {
          ...
          public static int sumaviaticosf1(String fechainicial, String fechafinal)
        {
            ...
            try
            {
                MySqlCommand comando = new MySqlCommand(String.Format("select sum(valor) from viaticos where (fecha between '{0}' and '{1}') and viaticos_id_maquinaria='7'", fechainicial, fechafinal), basededatos.con);
                basededatos.abrir();
                MySqlDataReader _reader = comando.ExecuteReader();
                Int64 Suma = 0;
                while (_reader.Read())
        ...
        public static int sumaviaticosf2(String fechainicial, String fechafinal)
        {
            ...
            try
            {
                MySqlCommand comando = new MySqlCommand(String.Format("select sum(valor) from viaticos where (fecha between '{0}' and '{1}') and viaticos_id_maquinaria='8'", fechainicial, fechafinal), basededatos.con);
                basededatos.abrir();
                MySqlDataReader _reader = comando.ExecuteReader();
                Int64 Suma = 0;
                while (_reader.Read())
        ...
        public static int sumaviaticosr1(String fechainicial, String fechafinal)
        {
            ...
            try
            {
                MySqlCommand comando = new MySqlCommand(String.Format("select sum(valor) from viaticos where (fecha between '{0}' and '{1}') and viaticos_id_maquinaria='1'", fechainicial, fechafinal), basededatos.con);
                basededatos.abrir();
                MySqlDataReader _reader = comando.ExecuteReader();
                Int64 Suma = 0;
                while (_reader.Read())
        ...
        public static int sumaviaticosr2(String fechainicial, String fechafinal)
        {
            ...
            try
            {
                MySqlCommand comando = new MySqlCommand(String.Format("select sum(valor) from viaticos where (fecha between '{0}' and '{1}') and viaticos_id_maquinaria='2'", fechainicial, fechafinal), basededatos.con);
                basededatos.abrir();
                MySqlDataReader _reader = comando.ExecuteReader();
                Int64 Suma = 0;
                while (_reader.Read())
        ...
        public static int sumaviaticosr3(String fechainicial, String fechafinal)
        {
            ...
            try
            {
                MySqlCommand comando = new MySqlCommand(String.Format("select sum(valor) from viaticos where (fecha between '{0}' and '{1}') and viaticos_id_maquinaria='3'", fechainicial, fechafinal), basededatos.con);
                basededatos.abrir();
                MySqlDataReader _reader = comando.ExecuteReader();
                Int64 Suma = 0;
                while (_reader.Read())
        ...
        public static int sumaviaticosr4(String fechainicial, String fechafinal)
        {
            ...
            try
            {
                MySqlCommand comando = new MySqlCommand(String.Format("select sum(valor) from viaticos where (fecha between '{0}' and '{1}') and viaticos_id_maquinaria='4'", fechainicial, fechafinal), basededatos.con);
                basededatos.abrir();
                MySqlDataReader _reader = comando.ExecuteReader();
                Int64 Suma = 0;
                while (_reader.Read())
        ...
        public static int sumaviaticosr5(String fechainicial, String fechafinal)
        {
            ...
            try
            {
                MySqlCommand comando = new MySqlCommand(String.Format("select sum(valor) from viaticos where (fecha between '{0}' and '{1}') and viaticos_id_maquinaria='5'", fechainicial, fechafinal), basededatos.con);
                basededatos.abrir();
                MySqlDataReader _reader = comando.ExecuteReader();
                Int64 Suma = 0;
                while (_reader.Read())
        ...
        public static int sumaviaticosr6(String fechainicial, String fechafinal)
        {
            ...
            try
            {
                MySqlCommand comando = new MySqlCommand(String.Format("select sum(valor) from viaticos where (fecha between '{0}' and '{1}') and viaticos_id_maquinaria='6'", fechainicial, fechafinal), basededatos.con);
                basededatos.abrir();
                MySqlDataReader _reader = comando.ExecuteReader();
                Int64 Suma = 0;
                while (_reader.Read())
        ...
        public static int sumaviaticosSNZ(String fechainicial, String fechafinal)
        {
            ...
            try
            {
                MySqlCommand comando = new MySqlCommand(String.Format("select sum(valor) from viaticos where (fecha between '{0}' and '{1}') and viaticos_id_maquinaria='9'", fechainicial, fechafinal), basededatos.con);
                basededatos.abrir();
                MySqlDataReader _reader = comando.ExecuteReader();
                Int64 Suma = 0;
                while (_reader.Read())
